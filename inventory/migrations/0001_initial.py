# Generated by Django 5.1.3 on 2025-05-31 18:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, default='', help_text="Enter phone number in the format: '+999999999'", max_length=17, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^\\+?1?\\d{9,15}$')])),
        ...
        migrations.AddField(
            model_name='employee',
            name='position',
            field=models.ForeignKey(db_column='position_id', on_delete=django.db.models.deletion.PROTECT, related_name='employees', to='inventory.position'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['status', 'created_at'], name='inventory_n_status_b440fc_idx'), models.Index(fields=['employee_profile', 'status'], name='inventory_n_employe_37314b_idx'), models.Index(fields=['content_type', 'object_id'], name='inventory_n_content_41af1e_idx')],
            },
        ),
    ]
